...
#' the model predicted the disease accurately whereas beyond 1 (ie 3 and 5),the 
#' model misbehaved. This shows that time step is an important parameter to consider
# when modelling diseases in SIS models
