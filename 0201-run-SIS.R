...
#'In this population, the number of infected is exponentially increasing 
#'while the number of susceptible is decreasing until equilibrium is reached . 
#'This shows that with high basic reproduction ratio i.e. R0>1,
#' there is high disease spread in a population.
#'
#' #Add, the column for proportion of susceptible in a population
...
#'
#'#'Then we can see no changes between number of infected and susceptible, 
...
#'of susceptible in a population varies with basic reproduction number as:
#'
...
#'susceptible vary with different transmission rate as well as how the 
#'proportion of the susceptible is related to reciprocal of R0 (i.e.1/R0).  
#'
...
#'Add the columns of total population size and latest susceptibles in a data frame, so as to get the proportion of susceptible individuals.
...
#'
#'In general, the values of 1/R0 and proportion of susceptible in a population 
#'are similar (since the difference is very minimal) which means higher the basic 
#'reproduction ratio in a population, the larger the number of the population
#' will be infected. In other words the population will remain with a very low
#' proportion of uninfected individuals (susceptible).
#' 
#' 
#'
#'
